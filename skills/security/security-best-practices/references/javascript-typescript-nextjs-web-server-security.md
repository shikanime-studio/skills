...
### NEXT-SUPPLY-001: Keep Next.js supported and patch advisories quickly
...
### NEXT-SECRETS-002: Avoid server-only to client bundling mistakes
...
### NEXT-AUTH-001: Enforce auth on every protected server action
...
### NEXT-ACTION-002: Avoid leaking secrets through Server Action closures
...
### NEXT-ERROR-001: Error handling must not leak implementation details
...
### NEXT-PROXY-001: Proxy and middleware must not forward unsafe headers
...
### NEXT-DOS-001: Add rate limits and resource controls for abuse-prone endpoints
