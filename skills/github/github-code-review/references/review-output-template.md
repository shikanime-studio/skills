...
Use this as the structure for PR review summary comments. Copy and fill in the
sections.
...
**Verdict: [Approved ✅ | Changes Requested 🔴 | Reviewed 💬]** ([N] issues, [N]
suggestions)

**PR:** #[number] — [title] **Author:** @[username] **Files changed:** [N]
(+[additions] -[deletions])
