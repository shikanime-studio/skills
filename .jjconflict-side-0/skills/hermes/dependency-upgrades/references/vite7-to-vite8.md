...
- **NativeDecorator lowering**: Oxc does not support it yet. Use `@rolldown/plugin-babel` with `@babel/plugin-proposal-decorators` (version `2023-11`) or `@rollup/plugin-swc`.
